...
# software
ref=/ifs1/User/pengjx/project/Rice/02.evaluate/mapping/NGS/version_1/R900/R900.fasta
picard=/ifs1/User/pengjx/biosoft/picard.jar
#gatk=/data/software/soft/gatk-3.8-1/GenomeAnalysisTK.jar
bwa=/ifs1/User/pengjx/biosoft/anaconda3/bin/bwa
samtools=/ifs1/Software/biosoft/samtools/samtools
java=/ifs1/User/pengjx/biosoft/anaconda3/bin/java

# step1: 
# please use raw fastq data for bwa alignment directly instead of clean data.
$bwa mem -t 10 -M -R "@RG\tID:$sample\tLB:$sample\tSM:$sample" $ref $fastq1 $fastq2|$samtools view -b -t ${ref}.fai - > ${sample}.bam
